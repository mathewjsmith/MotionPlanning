...
begin
	...
	using MotionPlanning.GeneticAlgorithms.ConstraintGA
...
inst = readinstance("../instances/uniform/small_013_20x20_50_186.instance.json")
...
sol, chrom = evolve(inst, Params(24, 4, 0.95, 0.01, 30))
...
# ╔═╡ 3251d10b-bde0-4fe9-96e1-f062b5c30cb4
sum(chrom)
